...
import (
	...
	"github.com/phantomnat/go-clean-architecture/article/repository"
	"github.com/phantomnat/go-clean-architecture/article/repository/mysql"
...
func TestFetch(t *testing.T) {
	...
	a := mysql.NewMysqlArticleRepository(db)
